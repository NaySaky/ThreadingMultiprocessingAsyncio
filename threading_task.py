...
def simulate_io_task(file_name, duration):
    ...
    try:
        response = requests.get('https://raw.githubusercontent.com/NaySaky/ThreadingMultiprocessingAsyncio/refs/heads/main/numbers.txt', timeout=10)
...
def run_io_tasks():
    ...
    file_names = ['result.txt', 'result2.txt', 'result3.txt', 'result4.txt', 'result5.txt']
    duration = 2  
    threads = []
